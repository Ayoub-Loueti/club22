...
function Signup() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post('http://54.242.240.123/signup', {
        email,
        motDePasse: password,
      });
      Swal.fire(
            ...
            >
              ...
              {isPasswordFocused && (
                <div
                  ...
                  className="password-validation-popup"
                >
                  <p>
                ...
                <div className="form-group">
                  ...
                  {isPasswordFocused && (
                    <div className="password-validation-popup">
                      ...
                      <ul>
                        <li
                          className={hasLength(password) ? 'valid' : 'invalid'}
                        >
                          <span className="icon"></span>12 caractères ou plus
                        </li>
                        <li
                        ...
                        <li
                          className={hasNumber(password) ? 'valid' : 'invalid'}
                        >
                          <span className="icon"></span>au moins un chiffre
                        </li>
                      </ul>
